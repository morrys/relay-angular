...
export function getRefetchMetadata(
    ...
    const refetchMetadata: ReaderRefetchMetadata = fragmentNode.metadata?.refetch as any;
    invariant(
    ...
    const refetchableRequest: ConcreteRequest = (refetchMetadata as any).operation.default
        ...
        : (refetchMetadata as any).operation;
    const fragmentRefPathInResponse = (refetchMetadata as any).fragmentPathInResult;
    invariant(
    ...
    const identifierField = (refetchMetadata as any).identifierField;
    invariant(
