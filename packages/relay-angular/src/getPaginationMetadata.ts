...
export function getPaginationMetadata(
    ...
    const { refetchableRequest: paginationRequest, refetchMetadata } = getRefetchMetadata(fragmentNode, componentDisplayName);

    const paginationMetadata: ReaderPaginationMetadata = refetchMetadata.connection as any;
    invariant(
    ...
    const identifierField = refetchMetadata.identifierField as string;
    invariant(
