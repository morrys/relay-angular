const siteConfig = {
    ...
    tagline: 'Collection of libraries usable for relay-angular.',
    url: 'https://morrys.github.io',
    baseUrl: '/relay-angular/',
    projectName: 'relay-angular',
    organizationName: 'morrys',
    headerLinks: [
        { doc: 'relay-angular', label: 'Docs' },
        {
            href: 'https://github.com/morrys/relay-angular',
            label: 'GitHub',
        },
        { languages: false },
    ],
  ...
  */
    ...
    repoUrl: 'https://github.com/morrys/relay-angular',
